package com.my.formerseller.Chat;
...
import com.my.formerseller.databinding.ActivityMsgChatBinding;
...
/*    private void ResetChatCount() {
    ...
    private void sendPushNotificaton(String msg){
        ...
        String SenderId= Preference.get(MsgChatAct.this,Preference.KEYType_login);
